...
public class ContractProfile : Profile
{
    ...
    {
        CreateMap<TranslationEngine, TranslationEngineResult>().ForMember(c => c.EngineId, o => o.MapFrom(m => m.Id));
        ...
        CreateMap<Engine.Translation.V1.TranslationResult, Contracts.TranslationResult>();
        CreateMap<Engine.Translation.V1.AlignedWordPair, Contracts.AlignedWordPair>();
        CreateMap<Engine.Translation.V1.Phrase, Contracts.Phrase>();
