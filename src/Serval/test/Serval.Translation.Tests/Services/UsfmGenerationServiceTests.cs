    ...
    public async Task GetUsfmAsync_Source_PlaceMarkers()
    {
        ...
        Assert.That(
            ...
            Is.EqualTo(
                    @"\id MAT - Test1
\c 1
\rem This draft of MAT 1 was generated by AI from Te1 on 1970-01-01 00:00:00Z. It should be reviewed carefully for errors before use. Paragraph break positions were preserved.
    ...
    public async Task GetUsfmAsync_StripAllMarkers()
    {
        ...
        Assert.That(
            ...
            Is.EqualTo(
                    @"\id MAT - Test1
\c 1
\rem This draft of MAT 1 was generated by AI from Te1 on 1970-01-01 00:00:00Z. It should be reviewed carefully for errors before use. Paragraph breaks were removed.
\v 1 Chapter 1, verse 1. ""Translated new paragraph""
\p
\v 2 Chapter 1, verse 2.
\v 3
