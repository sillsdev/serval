...
public class StatusTests
{
    ...
    public async Task GetDeploymentAsync()
    {
        ...
        Assert.That(deploymentInfo.AspNetCoreEnvironment, Is.Not.EqualTo("Unknown"));
    }
    ...
    public async Task GetPingAsync()
    {
        ...
        Assert.That(healthReport, Is.Not.Null);
        Assert.That(healthReport.Status.ToString(), Is.Not.EqualTo("Healthy"));
        Assert.That(healthReport.Results, Is.Empty);
    }
    ...
    private class TestEnvironment : DisposableBase
    {
        ...
        public StatusClient CreateClient(IEnumerable<string>? scope = null)
        {
