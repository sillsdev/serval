...
namespace Serval.Client
{
    ...
    public partial interface IApiKeysClient
    {
        ...
        /// <br/>            
        /// <br/>API key management is intended for administrative use only. A key can be created for any client with any
        /// <br/>grantable scopes, so the `create:api_keys`, `read:api_keys`, and `delete:api_keys` scopes should only be
        /// <br/>granted to trusted administrative clients.
        /// </remarks>
        /// <param name="apiKeyConfig">The API key configuration.</param>
        /// <returns>The API key was created successfully.</returns>
        /// <exception cref="ServalApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<ApiKeyCreated> CreateAsync(ApiKeyConfig apiKeyConfig, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <exception cref="ServalApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.IList<ApiKey>> GetAllAsync(string? clientId = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <br/>can still be retrieved. Revoking an API key that is already revoked has no effect.
        /// </remarks>
        /// <param name="id">The API key id.</param>
        /// <returns>The API key was successfully revoked.</returns>
        /// <exception cref="ServalApiException">A server side error occurred.</exception>
        ...
        /// <exception cref="ServalApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<ApiKey> GetAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// <returns>The API key was created successfully.</returns>
        /// <exception cref="ServalApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ApiKeyCreated> CreateAsync(ApiKeyConfig apiKeyConfig, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (apiKeyConfig == null)
                throw new System.ArgumentNullException("apiKeyConfig");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    var json_ = Newtonsoft.Json.JsonConvert.SerializeObject(apiKeyConfig, JsonSerializerSettings);
                    ...
                    try
                    {
                        ...
                        if (status_ == 201)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ApiKeyCreated>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ServalApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ServalApiException("The API key configuration is invalid.", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 503)
                        {
        ...
        /// <returns>The API keys.</returns>
        /// <exception cref="ServalApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.IList<ApiKey>> GetAllAsync(string? clientId = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.IList<ApiKey>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ServalApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ServalApiException("The API key does not exist.", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 503)
                        {
        ...
        /// <returns>The API key.</returns>
        /// <exception cref="ServalApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ApiKey> GetAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
    ...
    public partial interface ITranslationEnginesClient
    {
        ...
        /// <br/>            
        /// <br/>See [here](https://github.com/sillsdev/serval/wiki/Build-Diagnostics) for information about diagnostics emitted during the build process.
        /// </remarks>
        /// <param name="id">The translation engine id</param>
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.7.1.0 (NJsonSchema v11.6.1.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ApiKeyCreated : ApiKey
    {
    ...
    public partial class ApiKey
    {
        ...
        [System.ComponentModel.DataAnnotations.Required]
        public System.Collections.Generic.IList<string> Scopes { get; set; } = new System.Collections.ObjectModel.Collection<string>();
    ...
    public partial class ExecutionData
    {
        ...
        public System.Collections.Generic.IList<Diagnostic>? Diagnostics { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("diagnosticsTruncated", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool? DiagnosticsTruncated { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("averageAlignmentScore", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? AverageAlignmentScore { get; set; } = default!;
