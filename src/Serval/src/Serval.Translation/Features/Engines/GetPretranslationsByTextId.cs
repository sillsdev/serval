...
public record GetPretranslationsByTextId(string Owner, string EngineId, string ParallelCorpusId, string TextId)
    : IRequest<GetPretranslationsByTextIdResponse>;

public record GetPretranslationsByTextIdResponse(
    PretranslationStatus Status,
    IReadOnlyList<PretranslationDto>? Pretranslations = null
);

public class GetPretranslationsByTextIdHandler(
    IRepository<Engine> engines,
    IRepository<Pretranslation> pretranslations,
    ILogger<GetPretranslationsByTextIdHandler> logger
) : IRequestHandler<GetPretranslationsByTextId, GetPretranslationsByTextIdResponse>
{
    public async Task<GetPretranslationsByTextIdResponse> HandleAsync(
        GetPretranslationsByTextId request,
...
public partial class TranslationEnginesController
{
    ...
    public async Task<ActionResult<IEnumerable<PretranslationDto>>> GetPretranslationsByTextIdAsync(
        ...
        [FromServices] IRequestHandler<GetPretranslationsByTextId, GetPretranslationsByTextIdResponse> handler,
