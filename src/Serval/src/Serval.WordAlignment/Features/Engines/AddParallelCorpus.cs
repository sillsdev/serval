...
public record AddParallelCorpus(string Owner, string EngineId, WordAlignmentParallelCorpusConfigDto CorpusConfig)
    : IRequest<AddParallelCorpusResponse>;

public record AddParallelCorpusResponse(WordAlignmentParallelCorpusDto Corpus);
