...
public record GetAllEnginesResponse(IEnumerable<WordAlignmentEngineDto> Engines);
    ...
    : IRequestHandler<GetAllEngines, GetAllEnginesResponse>
{
    ...
    {
        IEnumerable<WordAlignmentEngineDto> dtos = (
...
public partial class WordAlignmentEnginesController
{
    ...
    public async Task<IEnumerable<WordAlignmentEngineDto>> GetAllAsync(
