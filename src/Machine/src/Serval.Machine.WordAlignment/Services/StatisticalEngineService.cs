...
public class StatisticalEngineService(
    ...
    IClearMLQueueService<WordAlignmentEngine> clearMLQueueService
) : IWordAlignmentEngineService
{
    ...
    private readonly IClearMLQueueService<WordAlignmentEngine> _clearMLQueueService = clearMLQueueService;
