...
[TestFixture]
public class EchoEngineServiceTests
{
    ...
    private class TestEnvironment : DisposableBase
    {
        ...
        public TestEnvironment()
        {
            ...
            var jobRunner = new LocalBuildJobRunner(
            ...
            Service = new EchoEngineService(platformService, Engines, buildJobService);
        }

        public EchoEngineService Service { get; }
