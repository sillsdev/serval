...
public class SmtTransferEngineServiceTests
{
    ...
    {
        private readonly ClearMLBuildJobRunner<TranslationEngine> _clearMLRunner;
        ...
        public TestEnvironment()
        {
            ...
            IOptionsMonitor<ClearMLOptions> clearMLOptions = Substitute.For<IOptionsMonitor<ClearMLOptions>>();
        ...
        public IClearMLQueueService<TranslationEngine> ClearMLMonitorService { get; }
        ...
        private TranslationEngineLocalBuildJobRunner CreateJobRunner()
        {
            return new TranslationEngineLocalBuildJobRunner(
