...
public class StatisticalEngineServiceTests
{
    ...
    {
        private readonly ClearMLBuildJobRunner<WordAlignmentEngine> _clearMLRunner;
        private readonly ServiceProvider _serviceProvider;
        private readonly IBuildJobService<WordAlignmentEngine>? _deferredBuildJobService;
        private readonly WordAlignmentEngineLocalBuildJobRunner _jobRunner;
        ...
        public IClearMLQueueService<WordAlignmentEngine> ClearMLMonitorService { get; }
        ...
        private WordAlignmentEngineLocalBuildJobRunner CreateJobRunner()
        {
            return new WordAlignmentEngineLocalBuildJobRunner(
