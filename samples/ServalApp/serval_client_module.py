...
class TrainingCorpus:
    def __init__(
        self, corpus: "ResourceLink", text_ids: Optional[List[str]] = None
    ) -> None:
        """Initializes with the given values."""
        self.corpus = corpus
...
def training_corpus_from_obj(obj: Any, path: str = "") -> TrainingCorpus:
    ...
    return TrainingCorpus(corpus=corpus_from_obj, text_ids=text_ids_from_obj)
...
def pretranslate_corpus_from_obj(obj: Any, path: str = "") -> PretranslateCorpus:
    ...
    return PretranslateCorpus(corpus=corpus_from_obj, text_ids=text_ids_from_obj)
...
class TrainingCorpusConfig:
    def __init__(self, corpus_id: str, text_ids: Optional[List[str]] = None) -> None:
        """Initializes with the given values."""
...
def training_corpus_config_from_obj(obj: Any, path: str = "") -> TrainingCorpusConfig:
    ...
    return TrainingCorpusConfig(
        corpus_id=corpus_id_from_obj, text_ids=text_ids_from_obj
    )
...
class RemoteCaller:
    ...
    def translation_engines_get_queue(self, engine_type: str) -> "Queue":
        """
