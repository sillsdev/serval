...
- Serval.ApiServer
  ...
  - Engine implementations (also hosted in-process):
    - `Serval.Machine.Shared` — NMT, SMT Transfer, Statistical, and Echo engine implementations; also runs Hangfire background build jobs and queues ClearML GPU training jobs
