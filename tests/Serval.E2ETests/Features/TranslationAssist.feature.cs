...
namespace Serval.E2ETests.Features
{
    ...
    public partial class TranslationAssistFeature
    {
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Get Nmt Pretranslation")]
        public void GetNmtPretranslation()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Get Nmt Pretranslation", null, tagsOfScenario, argumentsOfScenario, featureTags);
            this.ScenarioInitialize(scenarioInfo);
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
            {
                testRunner.SkipScenario();
            ...
            {
                this.ScenarioStart();
                testRunner.Given("a new Nmt engine for John from es to en", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
                testRunner.When("a text corpora containing MAT.txt, 1JN.txt, 2JN.txt are added to John\'s engine in" +
                        " es and en", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
                testRunner.And("a text corpora containing 3JN.txt are added to John\'s engine in es to translate i" +
                        "nto en", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
                testRunner.And("John\'s engine is built", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
                testRunner.Then("the pretranslation for John for 3JN.txt starts with \"The elder unto the\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
            }
            this.ScenarioCleanup();
        }
    }
